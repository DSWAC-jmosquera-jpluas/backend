...
{
    public class BaseRepository<T> : AccesoBaseDatos where T : /*BaseModel, */new()
    {
        protected SQLiteConnection ADB;

        public BaseRepository(string dbLocation) : base(dbLocation)
        {
            new AccesoBaseDatos(dbLocation);
        }
